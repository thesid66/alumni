...
if(!isset($_SESSION['BlogID'])){
	...
	echo "<script>window.location='jobdetail.html'</script>";
}
			...
			<div class="content">
				<div class="row wall-post">
					<div class="">
						...
						<div class="col-md-10">
						<h4 class="no-margin"><a href="<?php echo $URL ?>job/jobdetail.html?id=<?php echo $setPost->BlogID ?>"><?php echo $setPost->BlogName ?></a></h4>
							...
							<span>
									<a href="<?php echo $URL ?>job/likeblog.html?id=<?php echo $setPost->BlogID?>" name="bthLike"><span class="fa fa-heart"></span></a>
									<?php 
										if($setPost->UserID==$txtUserID) {
									?>
									<a href="<?php echo $URL ?>job/delblog.html?id=<?php echo $setPost->BlogID?>" name="bthDelete"><span class="fa fa-trash"></span></a>
									<?php
										}
									?>
								</span>
						...
						<div class="wall-desc">
							...
							<p class="post-prop"><?php echo date("l, M dS, Y \a\\t h:ia",$setComment->CommentDate) ?> • <?php echo $AllDetail->BatchYear ?> Batch 
								<span>
									...
									?>
									<a href="<?php echo $URL ?>job/delblogcmnt.html?id=<?php echo $setComment->recID?>" name="bthDelete"><span class="fa fa-trash"></span></a>
									<?php
										}
									?>
								</span>
