...
<div class="row">
		<div class="col-md-12">
			...
			<a class="pull-right btn btn-primary btn-fill btn-sm" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add New Post</a>
			<hr>
		</div>
	</div>
<div class="row">
	<div class="col-md-12">
		<?php
    		$getPost = $db->query("select * from tblblog where Type='0' order by BlogID desc");
				...
				<div class="card">
					<div class="content">
						<div class="row wall-post">
							<div class="wall-desc">
								<a href="<?php echo $URL ?>blog/blogdetail.html?id=<?php echo $setPost->BlogID ?>"><?php echo $setPost->BlogName ?></a><br>
									...
									<p class="post-prop"><a href="<?php echo $URL ?>blog/blogdetail.html?id=<?php echo $setPost->BlogID ?>" class="btn btn-primary btn-xs">Read More..</a> <span><?php echo countComment($setPost->BlogID,$db)?></span></p>
    ...
    <div class="card">
            ...
            <form method="post">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <textarea class="form-control" name="txtBlogDesc" placeholder="Add blog detail here!"></textarea>
                        </div>
                    </div>
